    const BOT_OPERATIONAL_CONFIGS = [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'netflix_monthly_gift_enabled', label: 'Bật quà Netflix hàng tháng', value: '1' },
          { key: 'netflix_monthly_gift_threshold', label: 'Ngưỡng nạp/mua để nhận quà Netflix', value: '200000' },
          { key: 'netflix_monthly_gift_start_at', label: 'Thời điểm bắt đầu tính quà Netflix', value: '2026-07-23T00:00:00+07:00' },
          { key: 'netflix_monthly_gift_notice', label: 'Text thông báo đủ điều kiện nhận quà', value: '🎁 Bạn đủ điều kiện nhận 1 vé xem Netflix miễn phí tháng này.\nĐiều kiện: nạp ví từ 200.000đ hoặc mua hàng tổng từ 200.000đ trong tháng.' },
          { key: 'netflix_monthly_gift_intro_message', label: 'Text quảng bá quà Netflix khi chưa đủ điều kiện', value: '🎁 Chương trình tháng này: nạp ví từ {threshold} hoặc mua hàng tổng từ {threshold} sẽ được tặng 1 vé xem Netflix miễn phí.\n\nTiến độ của bạn:\n• Đã nạp: {topup_total}\n• Đã mua: {purchase_total}\n• Còn thiếu: {remaining}' },
          { key: 'netflix_monthly_gift_claim_button', label: 'Text nút nhận quà Netflix', value: '🎁 Nhận vé Netflix 1 tháng' },
          { key: 'netflix_monthly_gift_topup_button', label: 'Text nút nạp tiền trong quảng bá quà', value: '💰 Nạp tiền' },
          { key: 'netflix_monthly_gift_shop_button', label: 'Text nút mua hàng trong quảng bá quà', value: '🛒 Xem sản phẩm' },
          { key: 'netflix_monthly_gift_loading_message', label: 'Text đang lấy quà Netflix', value: '⏳ Đang lấy vé Netflix miễn phí cho bạn...' },
          { key: 'netflix_monthly_gift_not_eligible_message', label: 'Text chưa đủ điều kiện/đã nhận quà', value: '⚠️ Bạn chưa đủ điều kiện hoặc đã nhận vé Netflix miễn phí tháng này.' },
          { key: 'netflix_monthly_gift_unavailable_message', label: 'Text khi quà Netflix đang tắt', value: '⚠️ Vé Netflix miễn phí hiện chưa khả dụng.' },
